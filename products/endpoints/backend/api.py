...
class EndpointViewSet(TeamAndOrgViewSetMixin, PydanticModelMixin, viewsets.ModelViewSet):
    ...
    def _execute_materialized_endpoint(
        ...
        try:
            ...
            # TODO: this here has some serious inconsistencies between insight and hogql-based endpoints.
            original_query_str = saved_query.query.get("query")
            if not original_query_str:
                raise ValidationError("Materialized query is missing query string")
