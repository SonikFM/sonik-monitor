...
export function EndpointConfiguration({ tabId }: EndpointConfigurationProps): JSX.Element {
    ...
    const effectiveMaterializationStatus = freshMaterialization?.status ?? versionMaterialization?.status
    const effectiveLastMaterializedAt =
        freshMaterialization?.last_materialized_at ?? versionMaterialization?.last_materialized_at
    const effectiveMaterializationError = freshMaterialization?.error ?? versionMaterialization?.error
